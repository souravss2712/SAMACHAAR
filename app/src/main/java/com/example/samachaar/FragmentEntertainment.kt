 ...
 * Use the [FragmentEntertainment.newInstance] factory method to
 * create an instance of this fragment.
 */
class FragmentEntertainment : Fragment() , NewsItemClicked{
...
//        val view: View = inflater.inflate(android.R.layout.fragment_entertainment, container, false)
//        recyclerView.layoutManager = LinearLayoutManager(view?.context)
//        fetchData()
//        mAdapter = NewsListAdapter(this)
//        recyclerView.adapter = mAdapter
//        return view
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentEntertainment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FragmentEntertainment().apply {
        ...
        fun getInstance(): FragmentEntertainment {
            val entertainmentfragment = FragmentEntertainment()
