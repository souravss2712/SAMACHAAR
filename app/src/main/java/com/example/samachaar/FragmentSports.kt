...
import kotlinx.android.synthetic.main.fragment_sports.view.recyclerView
 ...
 * Use the [FragmentSports.newInstance] factory method to
 * create an instance of this fragment.
 */
class FragmentSports : Fragment(), NewsItemClicked {
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentSports.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FragmentSports().apply {
        ...
        fun getInstance(): FragmentSports {
            val sportsfragment = FragmentSports()
