...
import kotlinx.android.synthetic.main.fragment_business.view.recyclerView
 ...
 * Use the [FragmentPolitics.newInstance] factory method to
 * create an instance of this fragment.
 */
class FragmentBusiness : Fragment(), NewsItemClicked {
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentPolitics.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FragmentBusiness().apply {
        ...
        fun getInstance(): FragmentBusiness {
            val businessfragment = FragmentBusiness()
